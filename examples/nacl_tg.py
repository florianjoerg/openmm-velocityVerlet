...
integ = VVIntegrator(temperature, REALFREQ, 1*kelvin, DRUDEFREQ, timestep, numDrudeSteps)
integ.setMaxDrudeDistance(0.02)

import pickle

pickle.dump(integ, open("sim.pkl", "wb"), pickle.HIGHEST_PROTOCOL)
integ = pickle.load(open("sim.pkl", "rb"))
...
pickle.dump(system, open("sim.pkl", "wb"), pickle.HIGHEST_PROTOCOL)
system = pickle.load(open("sim.pkl", "rb"))
...
# pickle.dump(simeq, open("sim.pkl", "wb"), pickle.HIGHEST_PROTOCOL)
# sim = pickle.load("sim.pkl")
